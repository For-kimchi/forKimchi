  ...
  <div class="container my-4">
    ...
    <div class="card p-3 mb-4">
      ...
      <div class="row g-3 mt-3">
        <div class="col-md-3">
          자재명<input v-model="searchName" type="text" class="form-control" placeholder="공정명" />
        </div>
        <div class="col-md-3">
          자재ID<input v-model="searchId" type="text" class="form-control" placeholder="공정ID" />
        </div>
        <div class="col-md-3">
          자재분류
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card p-3">
          ...
          <div class="mb-3">
            <label class="form-label">자재분류</label>
