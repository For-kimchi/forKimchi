            ...
            <div class="col-md-3">
              <div class="d-flex align-items-center">
                ...
                <input v-model="searchName" type="text" class="form-control border text-center" placeholder="자재명 : 엔터"
                  @keyup.enter="searchProdName(searchName)" />
              </div>
            </div>
            <div class="col-md-3">
              ...
              <table class="table align-items-center mb-0 table-hover">
                ...
                <tbody>
                  <tr v-for="(info, index) in prodQualityViewall" :key="info.quality_id"
                    v-on:click="prodQualityViewDetail(index)" :class="selectedIndex === index ? 'table-active' : ''"
                    ...
                    <td class="align-middle text-center">
                      <span v-if="info.final_result === '최종합격'" class="badge badge-sm bg-gradient-info"
