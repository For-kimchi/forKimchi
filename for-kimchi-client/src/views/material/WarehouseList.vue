    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="card my-4">
          ...
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div
              class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3 px-3 d-flex justify-content-between align-items-center">
              <!-- 창고 드롭다운 추가 -->
              ...
              <div class="btn-group bg-white rounded px-2 py-1 shadow-sm" role="group" aria-label="조회 방식 선택">
                <input type="radio" class="btn-check" id="lotView" value="lot" v-model="searchType" @change="wareSearch"
                  autocomplete="off">
                <label class="btn btn-sm btn-primary mb-0"
                  :class="searchType === 'lot' ? 'text-white' : 'bg-white text-primary border-primary'" for="lotView">
                  LOT별 조회
                </label>
                ...
                <label class="btn btn-sm btn-primary mb-0"
                  :class="searchType === 'group' ? 'text-white' : 'bg-white text-primary border-primary'"
                  for="groupView">
                  자재별 묶음 조회
                </label>
              </div>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr v-show="searchType === 'lot'">
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-10">창고명
                    </th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-10">LOT
                    </th>
