<template>
  <div class="container-fluid py-4">
    <nav class="text-center">
      ...
      <router-link to="/"><button class="btn btn-info ms-2 me-2">생산지시</button></router-link>
      <router-link to="/"><button class="btn btn-info ms-2 me-2">생산공정</button></router-link>
    </nav>
    <div class="row">
      <div class="col-12">
        <div class="row mt-3">
      ...
      <div class="row g-2 my-3 px-3">
        <div class="col-md-4">
          <div class="d-flex align-items-center">
            ...
            <input v-model="vendor_id" type="text" class="form-control border text-center" placeholder="거래처" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex align-items-center">
            <label class="form-label me-2 mb-0 text-center" style="width: 100px;">날짜</label>
            <input v-model="start_date" type="date" class="form-control border text-center"/> ~ <input v-model="end_date" type="date" class="form-control border text-center"/>
          </div>
        </div>
        <div class="col-md-4">
          <div class="d-flex align-items-center">
            <label class="form-label me-2 mb-0 text-center" style="width: 100px;">담당자</label>
            <input v-model="employee_id" type="text" class="form-control border text-center" placeholder="담당자" />
          </div>
        </div>
        <div class="col-md-4">
          <div class="d-flex align-items-center">
            <label class="form-label me-2 mb-0 text-center" style="width: 100px;">승인자</label>
            <input v-model="manager_id" type="text" class="form-control border text-center" placeholder="승인자" />
          </div>
        </div>
      </div>
    </div>
